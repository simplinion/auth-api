...
setValue(void* value, QJsonValue obj, QString type, QString complexType) {
    ...
    if(QStringLiteral("bool").compare(type) == 0) {
        ...
        *val = obj.toDouble();
    ...
    else if(type.startsWith("ChocoAuth") && obj.isObject()) {
        // complex type
        QJsonObject jsonObj = obj.toObject();
        ChocoAuthObject * so = (ChocoAuthObject*)::ChocoAuth::create(complexType);
        if(so != nullptr) {
            so->fromJsonObject(jsonObj);
            ChocoAuthObject **val = static_cast<ChocoAuthObject**>(value);
            if(*val != nullptr) delete *val;
            *val = so;
        }
    }
        ...
        // list of values
        if(complexType.startsWith("ChocoAuth")) {
            auto output = reinterpret_cast<QList<ChocoAuthObject *> **> (value);
            ...
            for (const QJsonValue & jval : arr) {
                // it's an object
                ChocoAuthObject * val = (ChocoAuthObject*)::ChocoAuth::create(complexType);
            ...
            for (const QJsonValue & jval : arr){
                qint32 val;
                ::ChocoAuth::setValue(&val, jval, QStringLiteral("qint32"), QStringLiteral(""));
            ...
            for (const QJsonValue & jval : arr){
                qint64 val;
                ::ChocoAuth::setValue(&val, jval, QStringLiteral("qint64"), QStringLiteral(""));
                (*output)->push_back(val);
            }
        }
            ...
            for (const QJsonValue & jval : arr){
                bool val;
                ::ChocoAuth::setValue(&val, jval, QStringLiteral("bool"), QStringLiteral(""));
                (*output)->push_back(val);
            }
        }
            ...
            for (const QJsonValue & jval : arr){
                float val;
                ::ChocoAuth::setValue(&val, jval, QStringLiteral("float"), QStringLiteral(""));
                (*output)->push_back(val);
            }
        }
            ...
            for (const QJsonValue & jval : arr){
                double val;
                ::ChocoAuth::setValue(&val, jval, QStringLiteral("double"), QStringLiteral(""));
                (*output)->push_back(val);
            }
        }
            ...
            for (const QJsonValue & jval : arr){
                ...
                ::ChocoAuth::setValue(&val, jval, QStringLiteral("QString"), QStringLiteral(""));
                (*output)->push_back(val);
            }
        }
            ...
            for (const QJsonValue & jval : arr){
                QDate * val = new QDate();
                ::ChocoAuth::setValue(&val, jval, QStringLiteral("QDate"), QStringLiteral(""));
                (*output)->push_back(val);
            }
        }
            ...
            for (const QJsonValue & jval : arr){
                ...
                ::ChocoAuth::setValue(&val, jval, QStringLiteral("QDateTime"), QStringLiteral(""));
                (*output)->push_back(val);
            }
        }
    }
        ...
        // list of values
        if(complexType.startsWith("ChocoAuth")) {
            auto output = reinterpret_cast<QMap<QString, ChocoAuthObject*> **> (value);
            for (auto item : **output) {
                if(item != nullptr) delete item;
            }
            (*output)->clear();
            ...
            if(varmap.count() > 0){
                for(auto itemkey : varmap.keys() ){
                    auto  val = (ChocoAuthObject*)::ChocoAuth::create(complexType);
                    auto  jsonval = QJsonValue::fromVariant(varmap.value(itemkey));
                    ::ChocoAuth::setValue(&val, jsonval, complexType, complexType);
            ...
            if(varmap.count() > 0){
                for(auto itemkey : varmap.keys() ){
                    qint32 val;
                    auto  jsonval = QJsonValue::fromVariant(varmap.value(itemkey));
                    ::ChocoAuth::setValue(&val, jsonval, QStringLiteral("qint32"), QStringLiteral(""));
                    (*output)->insert( itemkey, val);
                }
            }
        }
            ...
            if(varmap.count() > 0){
                for(auto itemkey : varmap.keys() ){
                    qint64 val;
                    auto  jsonval = QJsonValue::fromVariant(varmap.value(itemkey));
                    ::ChocoAuth::setValue(&val, jsonval, QStringLiteral("qint64"), QStringLiteral(""));
                    (*output)->insert( itemkey, val);
                }
            }
        }
            ...
            if(varmap.count() > 0){
                for(auto itemkey : varmap.keys() ){
                    bool val;
                    auto  jsonval = QJsonValue::fromVariant(varmap.value(itemkey));
                    ::ChocoAuth::setValue(&val, jsonval, QStringLiteral("bool"), QStringLiteral(""));
                    (*output)->insert( itemkey, val);
                }
            }
        }
            ...
            if(varmap.count() > 0){
                for(auto itemkey : varmap.keys() ){
                    float val;
                    auto  jsonval = QJsonValue::fromVariant(varmap.value(itemkey));
                    ::ChocoAuth::setValue(&val, jsonval, QStringLiteral("float"), QStringLiteral(""));
                    (*output)->insert( itemkey, val);
                }
            }
        }
            ...
            if(varmap.count() > 0){
                for(auto itemkey : varmap.keys() ){
                    double val;
                    auto  jsonval = QJsonValue::fromVariant(varmap.value(itemkey));
                    ::ChocoAuth::setValue(&val, jsonval, QStringLiteral("double"), QStringLiteral(""));
                    (*output)->insert( itemkey, val);
                }
            }
        }
            ...
            if(varmap.count() > 0){
                for(auto itemkey : varmap.keys() ){
                    QString * val = new QString();
                    auto  jsonval = QJsonValue::fromVariant(varmap.value(itemkey));
                    ::ChocoAuth::setValue(&val, jsonval, QStringLiteral("QString"), QStringLiteral(""));
                    (*output)->insert( itemkey, val);
                }
            }
        }
            ...
            if(varmap.count() > 0){
                for(auto itemkey : varmap.keys() ){
                    QDate * val = new QDate();
                    auto  jsonval = QJsonValue::fromVariant(varmap.value(itemkey));
                    ::ChocoAuth::setValue(&val, jsonval, QStringLiteral("QDate"), QStringLiteral(""));
                    (*output)->insert( itemkey, val);
                }
            }
        }
            ...
            if(varmap.count() > 0){
                for(auto itemkey : varmap.keys() ){
                    QDateTime * val = new QDateTime();
                    auto  jsonval = QJsonValue::fromVariant(varmap.value(itemkey));
                    ::ChocoAuth::setValue(&val, jsonval, QStringLiteral("QDateTime"), QStringLiteral(""));
                    (*output)->insert( itemkey, val);
                }
            }
        }
...
toJsonValue(QString name, void* value, QJsonObject& output, QString type) {
    ...
    if(type.startsWith("ChocoAuth")) {
        ChocoAuthObject *ChocoAuthobject = reinterpret_cast<ChocoAuthObject *>(value);
        if(ChocoAuthobject != nullptr) {
            QJsonObject o = ChocoAuthobject->asJsonObject();
            if(!name.isNull()) {
...
toJsonArray(QList<void*>* value, QJsonObject& output, QString innerName, QString innerType) {
    ...
    if(innerType.startsWith("ChocoAuth")){
        for(void* obj : *value) {
            ChocoAuthObject *ChocoAuthobject = reinterpret_cast<ChocoAuthObject *>(obj);
            if(ChocoAuthobject != nullptr) {
                outputarray.append(ChocoAuthobject->asJsonObject());
            }
        }
    }
...
toJsonMap(QMap<QString, void*>* value, QJsonObject& output, QString innerName, QString innerType) {
    ...
    QJsonObject mapobj;
    if(innerType.startsWith("ChocoAuth")){
        auto items = reinterpret_cast< QMap<QString, ChocoAuthObject*> *>(value);
        for(auto itemkey: items->keys()) {
            ::ChocoAuth::toJsonValue(itemkey, items->value(itemkey),mapobj, innerType);
        }
    }
    else if(QStringLiteral("QString").compare(innerType) == 0) {
        ...
        for(auto itemkey: items->keys()) {
            ...
            ::ChocoAuth::toJsonValue(itemkey, &val, mapobj, innerType);
        }
    }
    else if(QStringLiteral("qint64").compare(innerType) == 0) {
