...
ChocoAuthHttpRequestInput::ChocoAuthHttpRequestInput() {
    initialize();
}

ChocoAuthHttpRequestInput::ChocoAuthHttpRequestInput(QString v_url_str, QString v_http_method) {
    initialize();
    url_str = v_url_str;
    http_method = v_http_method;
}

void ChocoAuthHttpRequestInput::initialize() {
    var_layout = NOT_SET;
    url_str = "";
    http_method = "GET";
}

void ChocoAuthHttpRequestInput::add_var(QString key, QString value) {
    vars[key] = value;
}

void ChocoAuthHttpRequestInput::add_file(QString variable_name, QString local_filename, QString request_filename, QString mime_type) {
    ChocoAuthHttpRequestInputFileElement file;
...
ChocoAuthHttpRequestWorker::ChocoAuthHttpRequestWorker(QObject *parent)
    : QObject(parent), manager(nullptr)
{
    qsrand(QDateTime::currentDateTime().toTime_t());

    manager = new QNetworkAccessManager(this);
    connect(manager, &QNetworkAccessManager::finished, this, &ChocoAuthHttpRequestWorker::on_manager_finished);
}

ChocoAuthHttpRequestWorker::~ChocoAuthHttpRequestWorker() {
}

QString ChocoAuthHttpRequestWorker::http_attribute_encode(QString attribute_name, QString input) {
...
void ChocoAuthHttpRequestWorker::execute(ChocoAuthHttpRequestInput *input) {
    ...
    if (input->var_layout == ADDRESS || input->var_layout == URL_ENCODED) {
        ...
        // add files
        for (QList<ChocoAuthHttpRequestInputFileElement>::iterator file_info = input->files.begin(); file_info != input->files.end(); file_info++) {
    ...
    if (ChocoAuthHttpRequestWorker::sslDefaultConfiguration != nullptr) {
        request.setSslConfiguration(*ChocoAuthHttpRequestWorker::sslDefaultConfiguration);
    }
...
void ChocoAuthHttpRequestWorker::on_manager_finished(QNetworkReply *reply) {
...
QSslConfiguration* ChocoAuthHttpRequestWorker::sslDefaultConfiguration;
